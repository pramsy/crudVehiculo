...
<div id="carouselInicio" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{ asset('/imagens/1488.jpg') }}" class="img-fluid d-block h-75 w-80" alt="...">
    </div>
    <div class="carousel-item">
      <img src="{{ asset('/imagens/5435.jpg') }}" class="img-fluid d-block h-75 w-80" alt="...">
    </div>
    <div class="carousel-item">
      <img src="{{ asset('/imagens/67354.jpg') }}" class="img-fluid d-block h-75 w-80" alt="...">
    </div>
  </div>
